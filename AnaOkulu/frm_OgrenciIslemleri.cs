...
namespace AnaOkulu
{
    public partial class frm_OgrenciIslemleri : Form
    {
        ...
        void griddoldur()
        {
            SqlConnection baglanti = new SqlConnection(@"Data Source=DESKTOP-M5G8EPH;Initial Catalog=AnaOkulu;Integrated Security=True");
        ...
        private void btn_kaydet_Click(object sender, EventArgs e)
        {
            try
            {
                if (txt_TC.TextLength > 0 && txt_Ad.TextLength > 0 && txt_Soyad.TextLength > 0 && rich_adres.TextLength > 0)
                {
                    SqlConnection baglanti = new SqlConnection(@"Data Source=DESKTOP-M5G8EPH;Initial Catalog=AnaOkulu;Integrated Security=True");
                    baglanti.Open();
                    string kayit = "insert into Ogrenci(TC,Ad,Soyad,DogumTarihi,KayitTarihi,Sinif,Adres,VeliTC,OgretmenTC) values(@P1, @P2, @P3, @P4, @P5, @P6, @P7, @P8, @P9)";
                    ...
                    komut.Parameters.AddWithValue("@P8", txt_VeliTC.Text);
                    komut.Parameters.AddWithValue("@P9", txt_OgretmenTC.Text);
